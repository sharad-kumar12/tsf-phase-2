...
<strong><center><a style="color:Lime;" href="addpatientuser.php">CLICK HERE TO ADD MORE</a></br></br></center></strong>
<strong><center><a style="color:Lime;" href="showpatientpage.php">CLICK HERE TO SEE ALL ENTERED DATA</a></br></br></center></strong>
</font>
    </head>
    <body>
<?php
...
echo $_POST['admit_time']."<br/>";
echo $_POST['discharge_time']."<br/>";
echo $_POST['stay']."<br/>";
...
$autoquery="INSERT INTO `patient` (`id`, `patient_name`, `phone_number`,`admit_time`,`discharge_time`,`stay`,`amount_paid`,`mode_of_payment`,`insurance_provider`,`ward`,`address`)
VALUES ('".$_POST['id']."','".$_POST['patient_name']."','".$_POST['phone_number']."','".$_POST['admit_time']."','".$_POST['discharge_time']."','".$_POST['admit_time-discharge_time']."','".$_POST['amount_paid']."','".$_POST['mode_of_payment']."','".$_POST['insurance_provider']."','".$_POST['ward']."','".$_POST['address']."')";
